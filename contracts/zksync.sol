...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x523618825B5D6571782eA54DBBD2520a2882fCBa;
...
interface IUniswapV2Factory {
    ...
    function createPair(address tokenA, address tokenB,uint fee, bool feeType) external returns (address pair);
...
contract tolspad is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x523618825B5D6571782eA54DBBD2520a2882fCBa);
    ...
    string private _name = "Tolspad"; 
    string private _symbol = "ZTPAD";  
    ...
    */
    ...
    constructor () {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x8B791913eB07C32779a16750e3868aA8495F5964); 
        
        
        // // Create pair address for PancakeSwap
        // uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        //     .createPair(address(this), _uniswapV2Router.WETH(),250,false);
    ...
    */
    ...
    function set_New_Router_and_Make_Pair(address newRouter) public onlyOwner() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_newPCSRouter.factory()).createPair(address(this), _newPCSRouter.WETH(),250,false);
