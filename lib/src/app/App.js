    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Helmet, null,
                ...
                React.createElement("meta", { name: "description", content: "Plinko is an Ethereum dice game. It uses a smart contract based state channel implementation to provide a fast, secure and provably fair gambling experience." })),
