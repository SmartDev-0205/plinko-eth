import { GameType, getNumSetBits, getSetBits, KENO_FIELDS, KENO_SELECTABLE_FIELDS, maxBet, } from "@dicether/state-channel";
...
class Keno extends React.PureComponent {
    constructor(props) {
        super(props);
        this.loadedSounds = false;
        this.pickTimeoutId = 0;
        ...
        this.onPlaceBet = () => {
            const { keno, addNewBet, placeBet, catchError, showErrorMessage, web3Available, gameState, loggedIn } = this.props;
            ...
            if (canBet.canPlaceBet) {
                placeBet(num, safeBetValue, gameType)
                    ...
                    this.resultTimeoutId = window.setTimeout(() => this.setState({
                        showResult: false,
                        tmpResult: 0,
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Helmet, null,
                React.createElement("title", null, "Keno - Dicether"),
                React.createElement("meta", { name: "description", content: "Ethereum state channel based keno game" })),
            React.createElement(Ui, { num: num, value: value, maxBetValue: maxBetValue, onValueChange: this.onValueChange, onClick: this.onClick, onAutoPick: this.onAutoPick, onClear: this.onClear, onPlaceBet: this.onPlaceBet, showResult: showResult, showResultProfit: showResultProfit, result: Object.assign(Object.assign({}, result), { num: tmpResult }), showHelp: info.showHelp, onToggleHelp: this.onToggleHelp })));
    }
}
